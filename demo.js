...
//sum of consecutive even numbers: s = n(n+1)/2
function sumEvenNumber()//function definition
{
    var sum=0;
    //within the range 2-200 find the even numbers
    for(var i=2; i<=200; i++)
    {
...
function fibonacciSeries()//function definition
{
    //var count=20;
    var num1=0;
    var num2=1;
    var num3;
    var i=0;
    //within the range 0-20 find the Fibonacci numbers
    while(i<=20)
    {
        document.write( num1 +",");
        num3=num1+num2;
